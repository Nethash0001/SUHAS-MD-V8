...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "WctDkIhC#f4xdA2jzfPWO_T3n8kSLlvBruocXDfmZmxWIBYKx_aE", // 📌 𝗚𝗲𝘁 𝗦𝗲𝘀𝘀𝗶𝗼𝗻 𝗶𝗱 𝗶𝗻 𝗦𝗨𝗛𝗔𝗦-𝗠𝗗 𝗣𝗮𝗶𝗿 𝗦𝗶𝘁𝗲 📌
SUDO_NB: process.env.SUDO_NB || "", // +971561864977
